...
BOT_TOKEN = environ.get('BOT_TOKEN', "5365026848:AAG2uNwQZ8OWCOnJVqsm5d5a6_2DC9iwjHI")
...
MELCOW_VID = environ.get("MELCOW_VID", "https://telegra.ph/file/80cb40790fbef4c806e0f.mp4")
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001963175892')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002079935896')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'telugu_macha_group')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002081013037')).split()]
...
URL = "https://moviesearchbotop-rushikeshnarule3329.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://moviesearchbotop-rushikeshnarule3329.koyeb.app/".format(FQDN, PORT)
